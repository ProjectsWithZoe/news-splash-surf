...
const Bookmarks: React.FC = () => {
  ...
  useEffect(() => {
    ...
    try {
      const bookmarkKeys = Object.keys(localStorage).filter(key => key.startsWith('article_'));
      const savedBookmarks = bookmarkKeys.map(key => JSON.parse(localStorage.getItem(key) || '{}'));
          ...
          <div className="text-center py-16">
            <div className="glass-effect p-6 max-w-md mx-auto rounded-xl">
              ...
              <p className="text-muted-foreground mb-6">
                Save articles for later by clicking the bookmark icon when viewing an article.
              </p>
